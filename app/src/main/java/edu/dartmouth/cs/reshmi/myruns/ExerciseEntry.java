...
public class ExerciseEntry
{
    ...
    private ArrayList<String> mActivityCount;
    ...
    public ExerciseEntry() {
        ...
        mActivityCount = new ArrayList<String>();

        mLastLocation = null;
    }

    public ArrayList<String> getmActivityCount() {
        return mActivityCount;
    }

    public void addmActivityCount(String activity) {
        this.mActivityCount.add(activity);
    }
    ...
    public long getDateTimeInMillis() {return this.mDateTime.getTimeInMillis();}
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            obj.put("id", id);
            obj.put("inputType", mInputType);
            obj.put("activityType", mActivityType);
